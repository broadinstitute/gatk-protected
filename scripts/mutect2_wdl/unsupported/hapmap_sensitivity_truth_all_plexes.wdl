...
workflow HapmapSensitivityTruthAllPlexes {
    ...
    File five_plex_hc_vcf
    File five_plex_hc_vcf_idx
    File ten_plex_hc_vcf
    File ten_plex_hc_vcf_idx
    File twenty_plex_hc_vcf
    File twenty_plex_hc_vcf_idx
    ...
    call single_plex.HapmapSensitivityTruth as FivePlex {
        input:
          ...
          hc_vcf = five_plex_hc_vcf,
          hc_vcf_idx = five_plex_hc_vcf_idx,
          max_depth = max_depth
    }
    ...
    call single_plex.HapmapSensitivityTruth as TenPlex {
        input:
          ...
          dbsnp_intervals = dbsnp_intervals,
          min_indel_spacing = min_indel_spacing,
          hc_vcf = ten_plex_hc_vcf,
          hc_vcf_idx = ten_plex_hc_vcf_idx,
          max_depth = max_depth
    }
    ...
    call single_plex.HapmapSensitivityTruth as TwentyPlex {
        input:
          ...
          dbsnp_intervals = dbsnp_intervals,
          min_indel_spacing = min_indel_spacing,
          hc_vcf = twenty_plex_hc_vcf,
          hc_vcf_idx = twenty_plex_hc_vcf_idx,
          max_depth = max_depth
    }
