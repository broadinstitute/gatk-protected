 ...
 *
 * <p>
 *     Other components that require of a initialized HDF support library to function can require a non-null reference
...
public class HDF5Library {
     ...
     */
    public synchronized static HDF5Library getLibrary() {
        if (global == null) {
