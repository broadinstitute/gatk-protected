...
public final class CoverageModelEMComputeBlock {
    ...
    private static ImmutableComputableGraph createEmptyCacheGraph(final boolean biasCovariatesEnabled,
        ...
        cgbuilder
                /* E[log(c_{st})] */
                .externallyComputableNode(CoverageModelICGCacheNode.log_c_st.key)
                /* var[log(c_{st})] */
                .externallyComputableNode(CoverageModelICGCacheNode.var_log_c_st.key)
                /* E[log(d_s)] */
                .externallyComputableNode(CoverageModelICGCacheNode.log_d_s.key)
                /* var[log(d_s)] */
                .externallyComputableNode(CoverageModelICGCacheNode.var_log_d_s.key)
                /* E[\gamma_s] */
                .externallyComputableNode(CoverageModelICGCacheNode.gamma_s.key);

        if (biasCovariatesEnabled) {
            cgbuilder
                    /* mean of bias covariates */
                    .externallyComputableNode(CoverageModelICGCacheNode.W_tl.key)
                    /* E[z_{sm}] */
                    .externallyComputableNode(CoverageModelICGCacheNode.z_sl.key)
                    /* E[z_{sm} z_{sn}] */
                    .externallyComputableNode(CoverageModelICGCacheNode.zz_sll.key);
        }
    ...
    public INDArray getINDArrayFromCache(final CoverageModelICGCacheNode key) {
        return ((DuplicableNDArray)icg.getValueWithRequiredEvaluations(key.key)).value();
    }
    ...
    public double getDoubleFromCache(final CoverageModelICGCacheNode key) {
        return ((DuplicableNumber) icg.getValueWithRequiredEvaluations(key.key)).value().doubleValue();
    }
