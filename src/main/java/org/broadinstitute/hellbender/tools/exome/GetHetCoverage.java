...
/**
 * Outputs reference and alternate read counts at heterozygous SNP sites present in a normal sample
 * and, if specified, at the same sites in a tumor sample.
 *
 * <p>Non-Bayesian version of {@link GetBayesianHetCoverage}. See GetBayesianHetCoverage for modes.</p>
 *
