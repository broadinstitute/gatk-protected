...
import org.broadinstitute.hellbender.tools.exome.copyratio.CopyRatioData;
import org.broadinstitute.hellbender.tools.exome.copyratio.CopyRatioParameter;
import org.broadinstitute.hellbender.tools.exome.copyratio.CopyRatioState;
...
final class CopyRatioSamplers {
    ...
    protected static final class VarianceSampler implements ParameterSampler<Double, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioParameter, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData> {
        ...
        public Double sample(final RandomGenerator rng, final org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState state, final org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData dataCollection) {
            final Function<Double, Double> logConditionalPDF = newVariance -> {
                ...
                for (int segment = 0; segment < dataCollection.getNumSegments(); segment++) {
                    final List<org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData.IndexedCoverage> indexedCoveragesInSegment = dataCollection.getIndexedCoveragesInSegment(segment);
                    for (final org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData.IndexedCoverage c : indexedCoveragesInSegment) {
    ...
    protected static final class OutlierProbabilitySampler implements ParameterSampler<Double, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioParameter, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData> {
    ...
    protected static final class SegmentMeansSampler implements ParameterSampler<org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState.SegmentMeans, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioParameter, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData> {
        ...
        public org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState.SegmentMeans sample(final RandomGenerator rng, final org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState state, final org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData dataCollection) {
            ...
            return new org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState.SegmentMeans(means);
        }
    }
    ...
    protected static final class OutlierIndicatorsSampler implements ParameterSampler<org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState.OutlierIndicators, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioParameter, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData> {
        ...
        public org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState.OutlierIndicators sample(final RandomGenerator rng, final org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState state, final org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData dataCollection) {
            ...
            return new org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState.OutlierIndicators(indicators);
        }
    }
}
