...
import org.broadinstitute.hellbender.tools.exome.copyratio.CopyRatioSamplers;
...
public final class CopyRatioModeller {
    ...
    private final ParameterizedModel<org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioParameter, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState, org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData> model;
    ...
    public CopyRatioModeller(final SegmentedGenome segmentedGenome) {
        ...
        final org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData data = new org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioData(segmentedGenome);
        ...
        final org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState initialState = new org.broadinstitute.hellbender.tools.tumorheterogeneity.CopyRatioState(varianceEstimate, CopyRatioModeller.OUTLIER_PROBABILITY_INITIAL,
     ...
     * Should only be called after {@link org.broadinstitute.hellbender.tools.exome.copyratio.CopyRatioModeller#fitMCMC(int, int)} has been called.
