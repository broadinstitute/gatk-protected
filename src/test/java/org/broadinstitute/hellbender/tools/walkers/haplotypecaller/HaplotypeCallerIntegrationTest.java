...
public class HaplotypeCallerIntegrationTest extends CommandLineProgramTest {
    ...
    public void testVCFModeIsConcordantWithGATK3_7Results() throws Exception {
        ...
        // --out expected.testVCFMode.gatk3.7.vcf -stand_call_conf 30.0 \
        // --disableDithering --no_cmdline_in_header -dt NONE --maxReadsInRegionPerSample 100000000 --minReadsPerAlignmentStart 100000
        final File gatk3Output = new File(TEST_FILES_DIR + "expected.testVCFMode.gatk3.7.vcf");
    ...
    public void testVCFModeIsConcordantWithGATK3_7ResultsAlleleSpecificAnnotations() throws Exception {
        ...
        final File output = createTempFile("testVCFModeIsConcordantWithGATK3_7ResultsAlleleSpecificAnnotations", ".vcf");

        //Created by running
        //java -jar /humgen/gsa-hpprojects/GATK/private_unstable_builds//GenomeAnalysisTK-3.7-42-gbe6a37c/GenomeAnalysisTK.jar-T HaplotypeCaller \
        // -I src/test/resources/large/CEUTrio.HiSeq.WGS.b37.NA12878.20.21.bam \
        // -R src/test/resources/large/human_g1k_v37.20.21.fasta -L 20:10000000-10100000 \
        // --out expected.testVCFMode.gatk3.7.alleleSpecific.vcf -G StandardHC -G Standard -G AS_Standard -stand_call_conf 30.0 \
        // --disableDithering --no_cmdline_in_header -dt NONE --maxReadsInRegionPerSample 100000000 --minReadsPerAlignmentStart 100000
        final File gatk3Output = new File(TEST_FILES_DIR + "expected.testVCFMode.gatk3.7.alleleSpecific.vcf");
    ...
    public void testBamoutProducesReasonablySizedOutput() {
        ...
        // a bam with a number of reads that is within 10% of what GATK3.7 produces with
