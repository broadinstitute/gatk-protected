...
public class CalculatePulldownPhasePosteriorsIntegrationTest extends CommandLineProgramTest {
    ...
    public void testCalculatePhasePosteriors() {
        ...
        final Iterator<AlleleFractionSimulatedData.AlleleFractionPhase> phaseIterator = truePhases.iterator();
        ...
        while(phaseIterator.hasNext() && countWithPhasePosteriorsIterator.hasNext()) {
            final AlleleFractionSimulatedData.AlleleFractionPhase truePhase = phaseIterator.next();
            ...
            final AlleleFractionSimulatedData.AlleleFractionPhase maxProbPhase = AlleleFractionSimulatedData.AlleleFractionPhase.values()[indexOfMaxProbPhase];
