 ...
 */
public class TargetCovariateCorrectorUnitTest {
    ...
    public void testGCCorrection() {
        ...
        final ReadCountCollection correctedCounts1 = TargetCovariateCorrector.correctCoverage(rcc1, gcContentByTarget);
        ...
        final ReadCountCollection correctedCounts2 = TargetCovariateCorrector.correctCoverage(correctedCounts1, gcContentByTarget);
