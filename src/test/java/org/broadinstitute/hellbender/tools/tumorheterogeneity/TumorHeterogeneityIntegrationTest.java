...
//                new File("/home/slee/working/ipython/purity-ploidy/integration-test/1_clone/seed-1-cr-only/purity-1.0/total_segments-log2cr_sd-0.001-maf_sd-0.001.acnv.seg")
        ...
        for (final File ACNV_SEGMENT_FILE : ACNV_SEGMENT_FILES) {
            ...
            final String[] arguments = {
                    ...
                    "--" + TumorHeterogeneity.OUTLIER_PROBABILITY_PRIOR_ALPHA_LONG_NAME, "1",
                    "--" + TumorHeterogeneity.OUTLIER_PROBABILITY_PRIOR_BETA_LONG_NAME, "1E8",
                    "--" + TumorHeterogeneity.PLOIDY_MISMATCH_PENALTY_LONG_NAME, "1E4",
                    "--" + TumorHeterogeneity.SUBCLONE_VARIANCE_PENALTY_LONG_NAME, "1E-4",
                    "--" + TumorHeterogeneity.PLOIDY_STATE_PRIOR_HOMOZYGOUS_DELETION_PENALTY_LONG_NAME, "1E-4",
                    "--" + TumorHeterogeneity.PLOIDY_STATE_PRIOR_CHANGE_PENALTY_LONG_NAME, "1E-4",
    ...
    public void testTumorHeterogeneityHCC() {
        ...
        for (final File ACNV_SEGMENT_FILE : ACNV_SEGMENT_FILES) {
            ...
            final String[] arguments = {
                    ...
                    "--" + TumorHeterogeneity.OUTLIER_PROBABILITY_PRIOR_ALPHA_LONG_NAME, "1",
                    "--" + TumorHeterogeneity.OUTLIER_PROBABILITY_PRIOR_BETA_LONG_NAME, "1E2",
