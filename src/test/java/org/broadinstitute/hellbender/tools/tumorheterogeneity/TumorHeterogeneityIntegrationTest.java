    ...
    public void testTumorHeterogeneity() {
        for (final File ACNV_SEGMENT_FILE : ACNV_SEGMENT_FILES) {
            ...
            final String[] arguments = {
                    ...
                    "--" + TumorHeterogeneity.NUM_SAMPLES_CLONAL_LONG_NAME, "5000",
                    "--" + TumorHeterogeneity.NUM_BURN_IN_CLONAL_LONG_NAME, "1000",
                    "--" + TumorHeterogeneity.NUM_SAMPLES_LONG_NAME, "20000",
                    "--" + TumorHeterogeneity.NUM_BURN_IN_LONG_NAME, "5000",
                    "--" + TumorHeterogeneity.PROPOSAL_WIDTH_FACTOR_CLONAL_LONG_NAME, "10",
                    "--" + TumorHeterogeneity.PROPOSAL_WIDTH_FACTOR_LONG_NAME, "100",
                    ...
                    "--" + TumorHeterogeneity.COPY_RATIO_NOISE_FLOOR_PRIOR_ALPHA_LONG_NAME, "1E-1",
                    "--" + TumorHeterogeneity.COPY_RATIO_NOISE_FLOOR_PRIOR_BETA_LONG_NAME, "1E1",
                    "--" + TumorHeterogeneity.COPY_RATIO_NOISE_FACTOR_PRIOR_ALPHA_LONG_NAME, "1E-1",
                    "--" + TumorHeterogeneity.COPY_RATIO_NOISE_FACTOR_PRIOR_BETA_LONG_NAME, "1E2",
