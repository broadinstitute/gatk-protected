    ...
    public void testTumorHeterogeneity() {
        for (final File ACNV_SEGMENT_FILE : ACNV_SEGMENT_FILES) {
            ...
            final String[] arguments = {
                    ...
                    "--" + TumorHeterogeneity.NUM_BURN_IN_CLONAL_LONG_NAME, "1500",
                    "--" + TumorHeterogeneity.NUM_SAMPLES_LONG_NAME, "1000",
                    "--" + TumorHeterogeneity.NUM_BURN_IN_LONG_NAME, "750",
                    ...
                    "--" + TumorHeterogeneity.PLOIDY_STATE_PRIOR_CHANGE_PENALTY_LONG_NAME, "0.5",
                    "--verbosity", "DEBUG"
            };
