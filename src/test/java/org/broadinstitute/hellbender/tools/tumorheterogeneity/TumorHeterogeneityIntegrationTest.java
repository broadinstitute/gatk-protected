...
//    private static final File ACNV_SEGMENT_FILE = new File("/home/slee/working/ipython/purity-ploidy/integration-test/purity-1.0/total_segments-log2cr_sd-0.05-maf_sd-0.005.acnv.seg");
    private static final File ACNV_SEGMENT_FILE = new File("/home/slee/working/ipython/purity-ploidy/integration-test/purity-1.0/total_segments-log2cr_sd-0.001-maf_sd-0.001.short.acnv.seg");
    ...
    public void testTumorHeterogeneity() {
        final String[] arguments = {
                ...
                "--" + TumorHeterogeneity.NUM_SAMPLES_CLONAL_LONG_NAME, "10",
                "--" + TumorHeterogeneity.NUM_BURN_IN_CLONAL_LONG_NAME, "5",
                ...
                "--" + TumorHeterogeneity.METROPOLIS_ITERATION_FRACTION_LONG_NAME, "0.5",
