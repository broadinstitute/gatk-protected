    ...
    public void testTumorHeterogeneity1Clone() {
        ...
        for (final File ACNV_SEGMENT_FILE : ACNV_SEGMENT_FILES) {
            ...
            final String[] arguments = {
                    ...
                    "--" + TumorHeterogeneity.OUTLIER_PROBABILITY_PRIOR_ALPHA, "1E4",
                    "--" + TumorHeterogeneity.OUTLIER_PROBABILITY_PRIOR_BETA_LONG_NAME, "1",
    ...
    public void testTumorHeterogeneityHCC() {
        ...
        for (final File ACNV_SEGMENT_FILE : ACNV_SEGMENT_FILES) {
            ...
            final String[] arguments = {
                    ...
                    "--" + TumorHeterogeneity.OUTLIER_PROBABILITY_PRIOR_ALPHA, "1E6",
                    "--" + TumorHeterogeneity.OUTLIER_PROBABILITY_PRIOR_BETA_LONG_NAME, "1",
                    "--" + TumorHeterogeneity.MINOR_ALLELE_FRACTION_NOISE_FACTOR_PRIOR_ALPHA_LONG_NAME, "1E6",
                    "--" + TumorHeterogeneity.MINOR_ALLELE_FRACTION_NOISE_FACTOR_PRIOR_BETA_LONG_NAME, "1",
    ...
    public void testTumorHeterogeneity2Clone() {
        ...
        for (final File ACNV_SEGMENT_FILE : ACNV_SEGMENT_FILES) {
            ...
            final String[] arguments = {
                    ...
                    "--" + TumorHeterogeneity.COPY_RATIO_NOISE_CONSTANT_PRIOR_ALPHA_LONG_NAME, "1",
                    "--" + TumorHeterogeneity.COPY_RATIO_NOISE_CONSTANT_PRIOR_BETA_LONG_NAME, "1E2",
                    "--" + TumorHeterogeneity.OUTLIER_PROBABILITY_PRIOR_ALPHA, "1E2",
                    "--" + TumorHeterogeneity.OUTLIER_PROBABILITY_PRIOR_BETA_LONG_NAME, "1",
