...
public class TumorHeterogeneityStateUnitTest {
    ...
    static {
        ...
        PRIORS = new TumorHeterogeneityPriorCollection(
                NORMAL_PLOIDY_STATE, VARIANT_PLOIDY_STATE_PRIOR, DUMMY_HYPERPARAMETER, DUMMY_HYPERPARAMETER, DUMMY_HYPERPARAMETER, DUMMY_HYPERPARAMETER, DUMMY_HYPERPARAMETER, DUMMY_HYPERPARAMETER, DUMMY_HYPERPARAMETER, DUMMY_HYPERPARAMETER, DUMMY_HYPERPARAMETER);
        ...
        STATE = new TumorHeterogeneityState(concentration, copyRatioNoiseFloor, copyRatioNoiseFactor, minorAlleleFractionNoiseFactor, populationFractions, variantProfiles, PRIORS);
    ...
    public void testSinglePopulation() {
        ...
        new TumorHeterogeneityState(concentration, copyRatioNoiseFloor, copyRatioNoiseFactor, minorAlleleFractionNoiseFactor, populationFractions, variantProfiles, PRIORS);
    }
